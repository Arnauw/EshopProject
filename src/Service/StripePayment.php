...
class StripePayment
{
    ...
    public function __construct()
    {
        ...
        //recupère la cle secrete dans le fichier .env gràce au $_server
        Stripe::setApiVersion('2025-07-30.basil');
        //on gère la version de Stripe
    }
    ...
    public function startPayment($cart, $shippingCost, $orderId){
        ...
        $session = Session::create([
            ...
            'line_items'=>[
                ...
                array_map(fn(array $product) => [
                    ...
                    'price_data' => [
                        ...
                        //prix donnée en centimes donc on multiplie
                    ],
                ],$products)
            ],
            'mode' => 'payment',
            ...
            //si paiement annulé on redirige ici
            'success_url' => 'http://localhost:8000/pay/success',
            //si paiement réussi
            'billing_address_collection' => 'required',
            //si on autorise les factures
            'shipping_address_collection' => [
                //pays ou on souhaite autorise le paiement
    ...
    public function getStripeRedirectUrl(){
        //permet de recuperer l'url de l'utilisateur pour stripe
